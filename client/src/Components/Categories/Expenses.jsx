  ...
  return (
    <div className="bg-gray-100 flex flex-col justify-center items-center gap-8 p-8 border-2 rounded-xl">
      ...
      <div className="w-full">
        <h4 className="text-primary-500">Add Expense categories</h4>
      </div>
      <div className="flex flex-col w-full gap-4">
        ...
        ></textarea>
        <div className="w-full">
          <button className="btn btn-primary">Add Expense categories</button>
        </div>
      </div>
      <div className="w-full pt-8">
        <h4 className="text-primary-500">Expense Table</h4>
      </div>
      <div className="w-full">
