...
export default function NavBar({ layout, changeName, active }) {
  const openSideBar = () => {
  ...
  return (
    <div className="flex justify-between items-center max-sm:p-0">
      <div>
        <p className="lg:text-4xl text-2xl font-bold font-primary pl-1">
          {active}
        </p>
        <p className="lg:text-body-1 text-body-2 pl-1">Hello, Annartte !</p>
      </div>
